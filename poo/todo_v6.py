...
class Projeto:
    ...
    # Método "privado", pode ser acessado de fora
    # mas, por convenção, quando começa com underline
    # é um método privado.
...
def main():
    ...
    casa.add(TarefaRecorrente('Trocar lençóis', datetime.now(), 10))
    ...
    mercado.add('Carne')
    mercado.add('Frango', datetime.now() + timedelta(days=3, seconds=1))
    print('\n',mercado)
